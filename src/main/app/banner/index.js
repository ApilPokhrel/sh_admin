...
class Banner extends React.Component {
  ...
  state = {
    ...
    columns: [
      ...
      { title: "Sub1", dataIndex: "sub1", key: "sub1" },
      { title: "Sub2", dataIndex: "sub2", key: "sub2" },
  ...
  showEditModal = (e, c) => {
    this.setState({ banner: c, visible: { add: false, edit: true, profile: false } });
  };

  showEditProfileModal = (e, c) => {
    this.setState({ banner: c, visible: { add: false, edit: false, profile: true } });
  };
  ...
  handleEdit = () => {
    ...
    form.validateFields((err, values) => {
      ...
      Call.update(this.state.banner._id, values)
        .then(d => {
          form.resetFields();
          this.handleCancel();
          this.get();
  ...
  handleProfileEdit = () => {
    ...
    form.validateFields((err, values) => {
      ...
      Call.updateProfile(this.state.banner._id, values)
        .then(d => {
          form.resetFields();
          this.handleCancel();
          this.get();
